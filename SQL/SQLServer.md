- [SQL Server 笔记](#sql-server-笔记)
  ...
  - [6.视图和索引](#6视图和索引)
    ...
    - [6.1.2. 视图的创建](#612-视图的创建)
    - [6.1.3. 视图的修改（类似第四章的操作）](#613-视图的修改类似第四章的操作)
    - [6.1.4. 视图删除](#614-视图删除)
  - [6.2. 索引的创建与管理](#62-索引的创建与管理)
    - [6.2.1. 索引的概念](#621-索引的概念)
    - [6.2.2. 索引的分类](#622-索引的分类)
      - [6.2.2.1 何时创建索引](#6221-何时创建索引)
    - [6.2.3. 索引的创建](#623-索引的创建)
    - [6.2.4. 索引的管理](#624-索引的管理)
# SQL Server 笔记
